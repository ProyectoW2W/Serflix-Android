...
public class TestActivity extends AppCompatActivity implements RequestCallback{

    private SwipeCardsView swipeCardsView;
    private List<MovieRecommendation> movieList = new ArrayList<>();
    private List<MovieRecommendation> recommendations = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        swipeCardsView.setCardsSlideListener(new SwipeCardsView.CardsSlideListener() {
            ...
            public void onItemClick(View cardImageView, int index) {
                Log.d("Victor","Click en card "+index);
